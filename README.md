...
Low-altitude UAV Datasets · Data-centric AI · Structure-aware Synthesis · Low-shot Detection · Benchmark Construction
...
|:--|:--|:--|:--|
| **UAIV Dataset** | Dataset / Benchmark | A low-altitude multimodal UAV remote-sensing dataset for urban/ecological understanding, image restoration, and benchmark construction. | [Project](https://jennyzhang0810.github.io/LowAltitude-Multimodal-Dataset/) · [GitHub](https://github.com/JennyZhang0810/LowAltitude-Multimodal-Dataset/tree/main) · [ScienceDB](https://www.scidb.cn/detail?dataSetId=203705443be44f7882bb9ddfd7d401da) |
| **UAIV-Labeler** | Open-source Platform | A semi-automatic labeling platform for low-altitude UAV datasets. Supports Metadata-first indexing, model pre-annotation, human review, QA review, and Benchmark export. | [Code](https://github.com/JennyZhang0810/UAIV-Labeler) · [Live Demo](http://121.48.163.156:7860) |
